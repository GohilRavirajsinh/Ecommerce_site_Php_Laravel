...
@section('content')
  ...
  <body><br><br><br><br><br><br>
    ...
    <div class="swiper main-swiper">
      ...
      <div class="swiper-slide">
        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="banner-content">
            <h1 class="display-2 text-uppercase text-dark pb-5">Best Processor in 30K Segment!</h1>
            <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Click To Buy</a>
          </div>
          </div>
          <div class="col-md-5">
          <div class="image-holder">
            <img src="images/Iqoo_neo_10_R.png" alt="banner">
          </div>
          </div>
        </div>
        </div>
      ...
      <div class="swiper-slide">
        ...
        <div class="row d-flex flex-wrap align-items-center">
          <div class="col-md-6">
          <div class="banner-content">
            <h1 class="display-2 text-uppercase text-dark pb-5">Let's Get MVP!</h1>
            <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Click To Buy</a>
          </div>
          </div>
          <div class="col-md-5">
      ...
      <div class="swiper-slide">
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-6">
          <div class="banner-content">
            <h1 class="display-2 text-uppercase text-dark pb-5">Best #2 In Purchasing in March Boost Chiken Dinner
            !</h1>
            <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Click To Buy</a>
          </div>
          </div>
          <div class="col-md-5">
          <div class="image-holder">
            <img src="images/neo_10_R.png" alt="banner">
          </div>
          </div>
        </div>
        </div>
    ...
    <!-- Services Provides Like Free Delivery.. -->
    ...
    <div class="container">
      ...
      <div class="col-lg-3 col-md-6 pb-3">
        ...
        <div class="icon-box-content">
          ...
          <p>Free Delivery Available On $4 or More!</p>
        </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 pb-3">
        ...
        <div class="icon-box-content">
          <h3 class="card-title text-uppercase text-dark">Customer Service</h3>
          <p>Customer Service Available on Call And Email!</p>
        </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 pb-3">
        ...
        <div class="icon-box-content">
          ...
          <p>Daily Offers in Any One Order To 40 to 50% Off!.</p>
        </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 pb-3">
        ...
        <div class="icon-box-content">
          <h3 class="card-title text-uppercase textdark">100% secure payment</h3>
          <p>100% Secure Payment And 100% Refund! Availab</p>
        </div>
        </div>
      </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="swiper product-swiper">
        ...
        <div class="swiper-slide">
          ...
          <div class="image-holder">
            <img src="images/Iqoo_neo_10_R.png" alt="product-item" class="img-fluid">
          </div>
          ...
          <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
            ...
            <a href="#">Iqoo Neo 10 R</a>
            </h3>
            <span class="item-price text-primary">29550</span>
          </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="product-card position-relative">
          <div class="image-holder">
            <img src="images/iqoo12.jpg" alt="product-item" class="img-fluid">
          </div>
          <div class="cart-concern position-absolute">
            <div class="cart-button d-flex">
            <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline">
          ...
          <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
            ...
            <span class="item-price text-primary">46999</span>
          </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="product-card position-relative">
          <div class="image-holder">
            <img src="images/iqoo-neo9-pro.png" alt="product-item" class="img-fluid">
          </div>
          <div class="cart-concern position-absolute">
            <div class="cart-button d-flex">
            <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline">
          ...
          <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
            <h3 class="card-title text-uppercase">
            <a href="#">iqoo Neo 9 pro</a>
            </h3>
            <span class="item-price text-primary">33999</span>
          </div>
          </div>
        </div>
        <div class="swiper-slide">
          ...
          <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
            ...
            <span class="item-price text-primary">197000</span>
          </div>
          </div>
        </div>
        <div class="swiper-slide">
    ...
    <div class="swiper-
    ination position-absolute text-center"></div>
    </section>
    ...
    <!-- Ads Offer Scroll Under The Smart Watches -->
    <section id="yearly-sale" class="bg-light-blue overflow-hidden mt-5 padding-xlarge"
    style="background-image: url('images/banner-image.png');background-position: right; background-repeat: no-repeat;">
    <div class="row d-flex flex-wrap align-items-center">
      <div class="col-md-6 col-sm-12">
      <div class="text-content offset-4 padding-medium">
        <h3>23% off</h3>
        <h2 class="display-2 pb-5 text-uppercase text-dark">Summer Sale!</h2>
        <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Sales Items</a>
      </div>
      </div>
      <div class="col-md-6 col-sm-12">
    ...
    <div class="container">
      <div class="row">
      <div class="display-header d-flex justify-content-between pb-3">
        <h2 class="display-7 text-dark text-uppercase">Most Searched!</h2>
        <div class="btn-right">
    ...
    <!-- Subscribe Us Now Contact Through Mail -->
